...
import '../follower_list_screen/widgets/follower_list_item_widget.dart';
...
class _FollowerListScreenState extends State<FollowerListScreen> {
  List<UserBasicModel> followersList = [];
  late InfoProviders result;
  late List<UserBasicModel> listersData;
  ...
  Future getFollowersList() async {
    print("INIT STATE OF FOLLOWers LIST CALLED....");
    ...
    FirebaseFirestore.instance
      ...
      result.fetchUserData(listData, 'followers').then((_) {
        listersData = result.usersData;
        // debugPrint("DATALIST VALUE: ${listersData[0].name}");
        setState(() {
          isLoading = false;
        });
      });
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            itemCount:
                                                (listData['followers'] as List)
                                                    .length,
                                            itemBuilder: (context, index) {
                                              return FollowerListItemWidget(
                                                  // listData:
                                                  //         (listData['followers']
                                                  //             as List)[index],
                                                  userDataList:
