...
class ZIMPlugin {
  ...
  static void Function(String roomID, List<Map<String, dynamic>> memberList)?
      onRoomMemberJoined;
  static void Function(String roomID, List<Map<String, dynamic>> memberList)?
      onRoomMemberLeave;

  static void Function(String roomID, Map<String, dynamic> roomInfoJson)?
      onRoomInfoUpdate;
  static void Function(int state, int event)? onRoomStateChanged;
  static void Function(String roomID, Map<String, dynamic> speakerListJson)?
      onRoomSpeakerSeatUpdate;

  static void Function(
          String roomID, List<Map<String, dynamic>> textMessageListJson)?
      onReceiveTextRoomMessage;
  static void Function(
          String roomID, List<Map<String, dynamic>> customMessageListJson)?
      onReceiveCustomRoomMessage;
  static void Function(
          List<Map<String, dynamic>> customMessageListJson, String fromUserID)?
      onReceiveTextPeerMessage;
  static void Function(
          List<Map<String, dynamic>> customMessageListJson, String fromUserID)?
      onReceiveCustomPeerMessage;
  ...
  static Future<void> createZIM(int appID, String serverSecret) async {
    return await channel.invokeMethod(
        "createZIM", {"appID": appID, "serverSecret": serverSecret});
  }
  ...
  static Future<Map> createRoom(
      String roomID, String roomName, String hostID, int seatNum) async {
    return await channel.invokeMethod("createRoom", {
      "roomID": roomID,
      "roomName": roomName,
      "hostID": hostID,
      "seatNum": seatNum
  ...
  static Future<Map> sendPeerMessage(
      String userID, String message, bool isCustomMessage) async {
    return await channel.invokeMethod("sendPeerMessage", {
      "userID": userID,
      "message": message,
  ...
  static Future<Map> sendRoomMessage(
      String roomID, String message, bool isCustomMessage) async {
    return await channel.invokeMethod("sendRoomMessage", {
      "roomID": roomID,
      "message": message,
      'isCustomMessage': isCustomMessage
    });
  ...
  static Future<Map> setRoomAttributes(
      String roomID, String attributes, bool delete) async {
    return await channel.invokeMethod("setRoomAttributes",
        {"roomID": roomID, "attributes": attributes, "delete": delete});
  }
  ...
  static void eventListener(dynamic data) {
    ...
    switch (map['method']) {
      ...
      case 'roomAttributesUpdated':
        ...
        var roomID = map['roomID'];
        var updateInfo =
            Map<String, dynamic>.from(jsonDecode(map['updateInfo']));
      ...
      case 'receiveTextRoomMessage':
        ...
        var textMessagesJson =
            List<Map<String, dynamic>>.from(jsonDecode(map['messageList']));
        var roomID = map['roomID'];
