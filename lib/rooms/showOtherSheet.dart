...
import 'package:final_yr_project/rooms/show_admin_mute_setting.dart';
                ...
                Align(
                  child: Stack(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          // NAVIGATE TO OTHER USER SCREEN FOR THEIR PROFILE
    ...
    actions: <Widget>[
      ...
      TextButton(
        ...
        onPressed: () async {
          ...
          // .then((value) {
          debugPrint("ERROR CODE SHET: $errorC");
          if (errorC != 0) {
            Fluttertoast.showToast(
                msg: AppLocalizations.of(context)!
